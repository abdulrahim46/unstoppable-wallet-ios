...
extension ChartRouter {
    ...
    static func module(launchMode: ChartModule.LaunchMode) -> UIViewController {
        ...
        let interactor = ChartInteractor(rateManager: App.shared.rateManager, chartTypeStorage: App.shared.localStorage, currentDateProvider: CurrentDateProvider(), priceAlertManager: App.shared.priceAlertManager, localStorage: App.shared.localStorage, favoritesManager: App.shared.marketFavoritesManager)
